...
$app->get('/checkout', function(){
    ...
    if (isset($_GET['zipcode'])){
        ...
        $cep = str_replace('-', '', $_GET['zipcode']);
        
        $address->loadFromCEP($cep);        
                
        $cart->setdeszipcode($cep);        
...
$app->post('/register', function(){
    ...
    if (!isset($_POST['name']) || $_POST['name'] == ''){
        ...
        User::setErrorRegister("Preencha com o seu nome.");
    ...
    if (!isset($_POST['email']) || $_POST['email'] == ''){
        ...
        User::setErrorRegister("Preencha com o seu e-mail.");
    ...
    if (!isset($_POST['phone']) || $_POST['phone'] == ''){
        ...
        User::setErrorRegister("Preencha com o seu telefone.");
    ...
    if (User::checkLoginExist($_POST['email'])){
        ...
        User::setErrorRegister("O e-mail informado ja esta cadastrado.");
...
$app->post('/profile', function(){
      ...
      if (!isset($_POST['desperson']) || $_POST['desperson'] === ''){
          ...
          User::setError("Preencha com o seu nome.");
      ...
      if (!isset($_POST['desemail']) || $_POST['desemail'] === ''){
          ...
          User::setError("Preencha com o seu e-mail.");
      ...
      if ($_POST['desemail'] !== $user->getdesemail()){
         ...
         if (User::checkLoginExist($_POST['desemail'])){
             ...
             User::setError("O e-mail informado ja esta cadastrado.");
      ...
      User::setSuccess("Os dados foram salvos.");
...
$app->post('/profile/change-password', function(){
    ...
    if ($_POST['current_pass'] === $_POST['new_pass']){
        ...
        User::setError("Mude a sua senha.");
    ...
    if ($_POST['new_pass'] !== $_POST['new_pass_confirm']) {
        ...
        User::setError("A senha nova difere da confirmacao.");
